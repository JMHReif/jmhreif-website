...
This post is the architecture piece. It lays out the mental model and the "why" behind each layer. If you want to skip ahead, the https://github.com/JMHReif/agents-mcp-ohmy[code is already on GitHub^], built with Java, Spring AI, and Neo4j, using a dataset of books, authors, and reviews (because I like to read, and it turns out reading data makes a great demo domain).
