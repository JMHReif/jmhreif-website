...
*Note:* for Neo4j instances outside of https://sandbox.neo4j.com/[Sandbox^] or https://console.neo4j.io/[Aura^], you will need to add the https://neo4j.com/labs/apoc/[APOC plugin^] for the import to succeed.
